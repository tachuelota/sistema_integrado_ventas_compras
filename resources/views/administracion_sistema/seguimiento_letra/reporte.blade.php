        ...
        <div class="box box-solid">
            ...
            <div class="box-body ">
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <a href="" class="btn btn-block btn-success" ng-click="LetraCtrl.filtrar_letras()"> Exportar <i class="fa fa-file-excel-o "></i></a>
                    </div>
                </div>
                <!-- <hr> -->
...
<script type="text/javascript">
    ...
    app.controller('DetallePagoController', function DetallePagoController(SeguimientoLetraFactory){
        ...
        vm.ventas_2013 = function(){
            SeguimientoLetraFactory.ventas_2013(vm.filtro);
        }
    });
    ...
    app.factory('SeguimientoLetraFactory', function SeguimientoLetraFactory($http, $modal, $filter ) {
        ...
        SeguimientoLetraFactory.ventas_2013 = function(scope) {
                // angular.element(div_loader).removeClass('hide');
            location.href='AdsDetallePago/ventas_2013';
                            // angular.element(div_loader).addClass('hide');
        }
