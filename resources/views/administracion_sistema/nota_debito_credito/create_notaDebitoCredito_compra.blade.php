                ...
                controller: function($scope, $modalInstance, Producto_create, Productos){
                    ...
                    $scope.seleccionar = function(data){
                        ...
                        if(AdsDetalleNotaFactory.CabeceraComprobante_create.moneda.id == 1){
                            ...
                            angular.element(label_precio).text('Precio Mínimo: $.'+formatNumber(data.precio_unitario/AdsDetalleNotaFactory.TipoCambio_today.tipo_cambio, ''));
                            
                            angular.element(precio_producto).removeClass('validate[required]');
                            angular.element(precio_producto).addClass('validate[required,min['+formatNumber(data.precio_unitario/AdsDetalleNotaFactory.TipoCambio_today.tipo_cambio, '')+']]');
                        ...
                        angular.element(stock).val(AdsDetalleNotaFactory.Producto_seleccionado.stock);
                        angular.element(unidad_medida).val(AdsDetalleNotaFactory.Producto_seleccionado.unidad_medida.nombre_unidad_medida);
