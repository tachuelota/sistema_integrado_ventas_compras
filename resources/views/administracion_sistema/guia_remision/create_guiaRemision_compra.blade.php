...
<script type="text/javascript">
    ...
    app.controller('AdsGuiaRemision', function AdsGuiaRemision(GuiaRemisionFactory){
        ...
        vm.angucomplete_proveedores = GuiaRemisionFactory.Proveedores;
            ...
            if($("#form_cabecera").validationEngine('validate')){
                ...
                if(vm.detalles_comprobante[0]!=null){
                    ...
                    var cabecera_create = {
                            ...
                            , proveedor : GuiaRemisionFactory.Proveedor_seleccionado
                            , direccion : GuiaRemisionFactory.Proveedor_seleccionado.direccion_seleccionada
        ...
        vm.seleccion_angucompleteproveedor = function(object){
            ...
            angular.copy(object.description,GuiaRemisionFactory.Proveedor_seleccionado)
            angular.element(proveedor_value).val(GuiaRemisionFactory.Proveedor_seleccionado.razon_social);
            angular.element(ruc).val(GuiaRemisionFactory.Proveedor_seleccionado.ruc);
        }

        GuiaRemisionFactory.getProductos();
        GuiaRemisionFactory.getProveedores();
        ...
        vm.buscarProveedor = function(){
            GuiaRemisionFactory.buscarProveedor();
        }

        vm.nuevoProveedor = function(){
            GuiaRemisionFactory.nuevoProveedor();
        }
    ...
    app.factory('GuiaRemisionFactory', function GuiaRemisionFactory($http, $modal ) {
        ...
        GuiaRemisionFactory.Proveedor_seleccionado = {};
        ...
        GuiaRemisionFactory.Proveedor_create = {};
        GuiaRemisionFactory.Proveedores = [];
                        ...
                        $http.post('AdsComprobanteVenta/getFacturaBySerieNumero', {guia:$scope.factura})
                            .success(function(data){
                                ...
                                if(data.datos == ''){
                                    ...
                                    GuiaRemisionFactory.Proveedor_seleccionado.id_cliente_seleccionado = data.datos[0].cliente_detalle.cliente.id;
                                    GuiaRemisionFactory.Proveedor_seleccionado.id_direccion_seleccionada = data.datos[0].cliente_detalle.id;
                                    GuiaRemisionFactory.Proveedor_seleccionado.direccion_seleccionada = data.datos[0].cliente_detalle.direccion_cliente;
        ...
        GuiaRemisionFactory.getProveedores = function() {
        angular.element(div_loader).removeClass('hide');
            return $http.get('AdsProveedor/getAllProveedores').success(function(data) {
        angular.element(div_loader).addClass('hide');
                console.log(data.datos);
                angular.copy(data.datos, GuiaRemisionFactory.Proveedores);
            });
        } 

        GuiaRemisionFactory.buscarProveedor = function(){
            $modal.open({
                ...
                controller: function($scope, $modalInstance, Proveedor_create, Proveedor){
                    ...
                    $scope.seleccionar = function(data){
                        ...
                        angular.copy(data, GuiaRemisionFactory.Proveedor_seleccionado);
                ...
                resolve: {
                    Proveedor_create : function(){
                        return GuiaRemisionFactory.Proveedor_create;
                    },
                    Proveedor : function(){
                        return GuiaRemisionFactory.Proveedores;
                    }
                }
            });
        }
        ...
        GuiaRemisionFactory.nuevoProveedor = function(){
            $modal.open({
                ...
                controller: function($scope, $modalInstance, $filter){
                    ...
                    $scope.store = function(){
                        if ( $("#create_form").validationEngine('validate') ) {
                            GuiaRemisionFactory.storeProveedor($scope.proveedor); /* Objeto de la vista */
                            $modalInstance.close();
                        };
                    }
                },
        ...
        GuiaRemisionFactory.storeProveedor = function(Proveedor) {
        angular.element(div_loader).removeClass('hide');
        ...
        GuiaRemisionFactory.store = function(cabecera, detalle) {
                angular.element(div_loader).removeClass('hide');
                 $http.post('AdsGuiaRemision', {cabecera:cabecera, detalle:detalle, compra_venta:4})
                    .success(function(data){
                        if(data.datos=='correcto'){
                            ...
                            angular.element(stock).val('');
                            angular.element(unidad_medida).val('');
                            angular.element(punto_partida_value).val('');
                            angular.element(punto_llegada_value).val('');
